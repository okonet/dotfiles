...
class Module {
  constructor(options) {
    ...
    if (sourceText !== undefined) {
      ...
      do { if (!(false)) (process._rawDebug("CHECK: false == true"), process.abort()) } while (0);
    }
...
class SyntheticModule extends Module {
  constructor(exportNames, evaluateCallback, options = {}) {
    ...
    this[kLink] = () => this[kWrap].link(() => { do { if (!(false)) (process._rawDebug("CHECK: false == true"), process.abort()) } while (0); });
  }
